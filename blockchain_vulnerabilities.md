...
A user submits a large buy order for a token, which enters the mempool.

A sophisticated bot monitoring the mempool detects this large, market-moving transaction.

The bot "sandwiches" the user's transaction:
